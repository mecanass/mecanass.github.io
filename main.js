...
module.exports = "<p>\nCeci est une petite application web pour mieux comprendre AngularJS et NodeJS. <a href=\"\" (click)=\"sendMeHome()\"><strong>Retourner à la page d'accueil</strong></a>.\n</p>\n<h2>Voici vos objectifs:</h2>\n<ul>\n  <li *ngFor=\"let goal of goals\">\n    {{ goal }}\n  </li>\n</ul>"
...
//add this reffrence to your components
...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<ul>\n  <li><a routerLink=\"\">Accueil</a></li>\n  <li><a routerLink=\"about/18\">A propos</a></li>\n</ul>\n<!--router display here-->\n<router-outlet></router-outlet>\n\n"
...
// import for 'two way data-binding'
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.goals = new rxjs_BehaviorSubject__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](['Finir la session', 'Dormir']);
        this.goal = this.goals.asObservable();
    }
    DataService.prototype.chnageGoal = function (goal) {
...
// importation des animations qu'on va utiliser 
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_data) {
        this._data = _data;
        this.itemCount = 4;
        this.btnText = 'Ajouter but';
        this.goalText = 'Mon objectif...';
        this.goals = ['I want to by an Audi', 'I want to travel to europe']; // array;
    }
    ...
    HomeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            // add to components those animations
            animations: [
...
module.exports = __webpack_require__(/*! C:\Users\Admin\Desktop\AngularProjects\FirstAPP\src\main.ts */"./src/main.ts");
